# File generated & created on: 2019-04-03 10:22:05.781609
...
class FileReader:
    ...
    def __init__(self):
        fileconverter = FileConverter()  # composition of
...
class Attribute:
    ...
    def __init__(self):
        classbuilder = ClassBuilder()  # composition of
...
class FileWriter:
    ...
    def __init__(self):
        filecontroller = FileController()  # aggregation of
